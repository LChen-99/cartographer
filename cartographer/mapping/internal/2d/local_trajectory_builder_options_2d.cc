 ...
 * @LastEditTime: 2023-03-01 16:32:11
 * @FilePath: /catkin_ws/src/cartographer/cartographer/mapping/internal/2d/local_trajectory_builder_options_2d.cc
...
proto::LocalTrajectoryBuilderOptions2D CreateLocalTrajectoryBuilderOptions2D(
  ...
  options.set_match_option(parameter_dictionary->GetInt("match_option"));
